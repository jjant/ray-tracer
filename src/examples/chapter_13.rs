...
pub fn scene(width: usize, height: usize) -> (Camera, World) {
    ...
    *cons1.transform_mut() = Matrix4::translation(1., 0., 0.) * Matrix4::scaling(0.8, 1., 0.8);
    ...
    w.objects.push(cons1);

    let mut cons2 = Cylinder::new();
    cons2.minimum = 0.;
    cons2.maximum = 0.3;
    cons2.closed = false;
    let mut cons2 = Object::new(Shape::Cylinder(cons2));
    *cons2.transform_mut() = Matrix4::translation(1., 0., 0.) * Matrix4::scaling(0.6, 1., 0.6);
    ...
    w.objects.push(cons2);

    let mut cons3 = Cylinder::new();
    cons3.minimum = 0.;
    cons3.maximum = 0.4;
    cons3.closed = false;
    let mut cons3 = Object::new(Shape::Cylinder(cons3));
    *cons3.transform_mut() = Matrix4::translation(1., 0., 0.) * Matrix4::scaling(0.4, 1., 0.4);
    ...
    w.objects.push(cons3);

    let mut cons4 = Cylinder::new();
    cons4.minimum = 0.;
    cons4.maximum = 0.5;
    cons4.closed = true;
    let mut cons4 = Object::new(Shape::Cylinder(cons4));
    *cons4.transform_mut() = Matrix4::translation(1., 0., 0.) * Matrix4::scaling(0.2, 1., 0.2);
    ...
    deco1.maximum = 0.3;
    deco1.closed = true;
    let mut deco1 = Object::new(Shape::Cylinder(deco1));
    *deco1.transform_mut() = Matrix4::translation(0., 0., -0.75) * Matrix4::scaling(0.05, 1., 0.05);
    ...
    w.objects.push(deco1);

    let mut deco2 = Cylinder::new();
    deco2.minimum = 0.;
    deco2.maximum = 0.3;
    deco2.closed = true;
    let mut deco2 = Object::new(Shape::Cylinder(deco2));
    *deco2.transform_mut() = Matrix4::translation(0., 0., -2.25)
    ...
    w.objects.push(deco2);

    let mut deco3 = Cylinder::new();
    deco3.minimum = 0.;
    deco3.maximum = 0.3;
    deco3.closed = true;
    let mut deco3 = Object::new(Shape::Cylinder(deco3));
    *deco3.transform_mut() = Matrix4::translation(0., 0., -2.25)
    ...
    w.objects.push(deco3);

    let mut deco4 = Cylinder::new();
    deco4.minimum = 0.;
    deco4.maximum = 0.3;
    deco4.closed = true;
    let mut deco4 = Object::new(Shape::Cylinder(deco4));
    *deco4.transform_mut() = Matrix4::translation(0., 0., -2.25)
    ...
    let mut glass_cylinder = Object::new(Shape::Cylinder(glass_cylinder));
